...
const animals = [
 {
  ...
  },
  {
   ...
   {
     name: "Havkat",
     image: "../../Images/animals/Havkat.png",
     category: "fish",
     description: "Har kraftige tænder til at knuse skaller",
     region: "Greenland",
     id: "havkat",
	 rarity: "uncommon",
     link: "learnmore.html"
...
function renderCategory(category, containerId) {
  ...
  const filteredAnimals = animals.filter(animal => animal.category === category);
...
function renderAllAnimals() {
  renderCategory("pattedyr", "pattedyr-list");
  renderCategory("birds", "fugle-list");
  renderCategory("fish", "fisk-list");
  updateTracker();
}
...
document.addEventListener("DOMContentLoaded", () => {
  if (document.getElementById("pattedyr-list")) {
    renderAllAnimals();
  }
